  ...
  (
    ...
    return (
      ...
      >
        ...
        <AccordionPrimitive.Content className="text-sm md:text-base data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down relative overflow-hidden h-full">
